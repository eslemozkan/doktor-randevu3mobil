  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#EFF5FB] to-white">
      <div className="container mx-auto px-4 py-8">
        ...
        <button
          onClick={() => navigate(-1)}
          className="mb-8 flex items-center text-[#394C8C] hover:text-[#5A70B9] transition-colors duration-300"
        >
        ...
        <div className="bg-white shadow-2xl rounded-3xl p-8 lg:p-12">
          <div className="flex items-center mb-12">
            ...
            <h1 className="text-2xl md:text-3xl font-bold text-[#1E2E62]">Detaylı Özgeçmiş</h1>
          </div>
          ...
          <div className="flex justify-center my-8">
            <button
              ...
              className="bg-[#394C8C] text-white px-6 py-2 text-sm md:text-base rounded-full hover:bg-[#2C3A6A] transition-colors
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {/* Tıp Eğitimi */}
            <div>
              <h2 className="text-xl md:text-2xl font-semibold text-[#394C8C] mb-8 flex items-center">
          ...
          <div className="mt-12 bg-[#F0F4F8] rounded-2xl p-8 shadow-md">
            <h2 className="text-xl md:text-2xl font-semibold text-[#394C8C] mb-6 flex items-center">
              <FontAwesomeIcon icon={faHeartPulse} className="mr-4" />
              İlgi Alanları
            </h2>
            <div className="grid md:grid-cols-2 gap-4">
              {interestAreas.map((area, index) => (
                <div key={index} className="flex items-center text-gray-700 text-sm md:text-base">
            ...
            <div className="space-y-4">
              {researchWorks.map((work, index) => (
                <div key={index} className="bg-white p-4 rounded-lg shadow-sm">
                  <h3 className="text-base md:text-lg font-semibold text-[#1E2E62] mb-2">{work.title}</h3>
                  <p className="text-gray-700 italic text-sm md:text-base">{work.citation}</p>
                </div>
              ))}
            </div>
          </div>
